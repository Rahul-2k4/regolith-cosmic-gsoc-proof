...
| 9 | Package audit: GNOME session/bootstrap removed, survivors justified | Partial | exact `22105aa6` Voulage packet from source candidate `1948857` and six-package metadata/ownership audit pass; the fresh [Ubuntu 26.04 local-pool closure](proof-notes/2026-08-17-ubuntu-resolute-local-pool-closure.md) installs the three session targets with clean `dpkg --audit`; GNOME survivor scope and exact graphical/archive replay remain open |
