...
readonly DISPLAYD_SOURCE=91bdd26
...
readonly DISPLAYD_SHA=1b8e348925497574163f0fd627523416b64cb7885451f5930a07c952a2b930f7
...
if [[ "${1:-}" == '--contract-test' ]]; then
  ...
  [[ "${DISPLAYD_SHA}" == 1b8e348925497574163f0fd627523416b64cb7885451f5930a07c952a2b930f7 ]]
